...
description: |
  提供涵盖 React、Node.js、数据库以及全栈架构的现代 Web 开发专家级知识体系。
  当执行以下任务时使用此技能：构建 Web 应用程序、开发 API、创建前端、设置数据库、部署 Web 应用，或者当用户提到 React、Next.js、Express、REST API、GraphQL、MongoDB、PostgreSQL 等全栈开发相关话题时触发。
license: MIT
metadata:
  author: awesome-llm-apps
  version: "1.0.0"
  short-description: 全栈 (Full-Stack) Web 开发者知识库
---
