---
name: ai-rules-sync
description: Sync smart_media SSOT rules/skills to platform directories (.trae/.lingma/.agent/.agents) and publish Codex skills to global ~/.agents/skills. Use after adding or editing any rules/agents/skills.
---
...
- `.trae/`, `.lingma/`, `.agent/`, `.agents/`, `AGENTS.md`
